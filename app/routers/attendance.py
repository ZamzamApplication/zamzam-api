...
from app.routers.auth import TenantContext, attendance_student_scope_clause, get_tenant_context
...
async def update_attendance(
    ...
    if context.restricts_attendance_students and body.sheikh_id is not None and body.sheikh_id != context.sheikh_id:
